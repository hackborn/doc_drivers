...
// autogenerated with github.com/hackborn/doc_drivers on 2024-05-21
// do not modify
...
func (h *fieldsAndValuesHandler) formatValue(name string, col genSqlTableCol, value any) any {
	switch col.format {
	case "json":
